...
--
-- Host: 127.0.0.1
-- Generation Time: 09 Jan 2017 pada 15.40
...
INSERT INTO `tb_news` (`news_id`, `news_category`, `news_title`, `news_headline`, `news_content`, `news_event_id`) VALUES
(2, 'Pendaftaran', 'DINAMIK UNTUK KITA SEMUA', '', '<p><strong>HMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM</strong></p>\r\n', 10);
...
--
ALTER TABLE `tb_pubteam`
  MODIFY `pubteam_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `tb_schparticipant`
  MODIFY `schparticipant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
-- AUTO_INCREMENT for table `tb_schteam`
--
ALTER TABLE `tb_schteam`
  MODIFY `schteam_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
