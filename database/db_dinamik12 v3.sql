...
--
-- Dumping data untuk tabel `tb_coordinator`
--
...
(3, 'OTIK', 'Olimpiade Teknologi Informasi dan Komunikasi', 1, 60000, 50, NULL, 'Olimpiade Teknologi Informasi dan Komunikasi (TIK) merupakan sebuah perlombaan bagi siswa/i SMA/SMK/sederajat untuk menguji kemampuan dan pengetahuan siswa tentang teknologi informasi dan komunikasi. Tema kegiatan ini adalah "Mahakarya Teknologi Bangsa Untuk Pendidikan Indonesia". Lomba ini bersifat kelompok (tim), sehingga kekompakan dan kerjasama sangat diperlukan untuk menyelesaikannya. Dalam lomba ini tim akan diberikan beberapa permasalahan yang harus dikerjakan dengan kurun waktu yang sudah panitia tetapkan. Materi yang diujikan dalam perlombaan ini adalah Teknik Komputer dan Jaingan (TKJ), Rekayasa Perangkat Lunak (RPL), Multimedia dan Elektronika Dasar.'),
...
(6, 'LCA', 'Lomba Cipta Animasi', 1, 100000, 50, NULL, 'Lomba Cipta Animasi (LCA) adalah salah satu cabang lomba di DINAMIK 12 yang dipertahankan dari lomba tahun sebelumnya. Lomba ini mengkompetisikan kemampuan peserta di bidang multimedia dalam pembuatan film pendek animasi 2D maupun 3D yang bertemakan "Inovasi Teknologi dalam Mendukung Dunia Pendidikan". Peserta dibebaskan menggunakan perangkat lunak apapun dalam proses pembuatannya. Lomba ini ditujukan untuk siswa/i SMA/SMK/sederajat se-Nasional.'),
...
--
-- Dumping data untuk tabel `tb_public`
--
...
--
-- Struktur dari tabel `tb_schparticipant`
--
...
--
-- Struktur untuk view `v_pubteam_dash`
--
...
--
-- Struktur untuk view `v_schteam_dash`
--
...
--
ALTER TABLE `tb_coordinator`
  MODIFY `coordinator_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
...
--
-- Ketidakleluasaan untuk tabel `tb_public`
--
ALTER TABLE `tb_public`
...
--
-- Ketidakleluasaan untuk tabel `tb_pubteam`
--
ALTER TABLE `tb_pubteam`
...
--
-- Ketidakleluasaan untuk tabel `tb_schparticipant`
--
ALTER TABLE `tb_schparticipant`
