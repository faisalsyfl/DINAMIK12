	...
	<!-- Tentang -->
	<div id="aboutdinamik" class="container parallax-window" data-parallax="scroll" data-image-src="<?php echo base_url("assets/img/parallax/tentang.jpg"); ?>">
		<div class="row">
			<div class="col-md-5">
				<div class="about-bg">
					<h3 class="title">
	...
	<!-- Kegiatan -->
	<div id="activitydinamik" class="container parallax-window" data-parallax="scroll" data-image-src="<?php echo base_url("assets/img/parallax/kegiatan.jpg"); ?>">
		<div class="row">
